...
LRESULT CALLBACK RegisterWndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        if (LOWORD(wParam) == IDC_BTN_REGISTER) 
        {
            ...
            GetDlgItemText(hWnd, IDC_CONFIRM_PASSWORD, confirmPassword, sizeof(confirmPassword));
...
LRESULT CALLBACK AdminManagementWndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        CreateWindow(L"BUTTON", L"信息调整管理", WS_VISIBLE | WS_CHILD, 90, 180, 120, 40, hWnd, (HMENU)ID_BTN_ADJUST_MANAGE, NULL, NULL);
        CreateWindow(L"STATIC", L"对实验中心的房间、实验员、设备类别、设备的信息进行调整和更改", WS_VISIBLE | WS_CHILD | SS_CENTER | SS_CENTERIMAGE, 240, 180, 480, 40, hWnd, NULL, NULL, NULL);

        CreateWindow(L"BUTTON", L"信息查询", WS_VISIBLE | WS_CHILD, 90, 240, 120, 40, hWnd, (HMENU)ID_BTN_QUERY, NULL, NULL);
        CreateWindow(L"STATIC", L"对实验中心的房间、实验员、设备类别、设备的信息进行查询", WS_VISIBLE | WS_CHILD | SS_CENTER | SS_CENTERIMAGE, 240, 240, 480, 40, hWnd, NULL, NULL, NULL);

        CreateWindow(L"BUTTON", L"信息排序", WS_VISIBLE | WS_CHILD, 90, 300, 120, 40, hWnd, (HMENU)ID_BTN_SORT, NULL, NULL);
        CreateWindow(L"STATIC", L"对实验中心的房间、实验员、设备类别、设备的信息进行排序", WS_VISIBLE | WS_CHILD | SS_CENTER | SS_CENTERIMAGE, 240, 300, 480, 40, hWnd, NULL, NULL, NULL);

        CreateWindow(L"BUTTON", L"信息统计", WS_VISIBLE | WS_CHILD, 90, 360, 120, 40, hWnd, (HMENU)ID_BTN_STATISTICS, NULL, NULL);
        CreateWindow(L"STATIC", L"对实验中心的房间、实验员、设备类别、设备的信息进行统计", WS_VISIBLE | WS_CHILD | SS_CENTER | SS_CENTERIMAGE, 240, 360, 480, 40, hWnd, NULL, NULL, NULL);
    ...
    case WM_COMMAND:
        ...
        case ID_BTN_INFO_MANAGE:
            ...
            break;
        case ID_BTN_ADJUST_MANAGE:
            //ShowAdjustManagementWindow(hWnd);
            break;
        case ID_BTN_QUERY:
